...
<script>${this.generateJS(metrics, topAccounts, historical, esr, byService, byInstance)}<\/script>
  ...
  <div class="page" id="optimization">
    <div class="grid grid-3" style="grid-template-columns:1fr 1fr 1fr">
      <div class="card kpi-card">
        <div class="kpi-label">Total Savings Available ${this.cldyLink('rightsizing/explorer?dimensions=vendor%2Cservice%2Caction%2Cregion&duration=ten-day&costBasis=on-demand')}</div>
    ...
    <div class="grid grid-2">
      <div class="chart-wrap">
        <h3>Waste by Category ${this.cldyLink('rightsizing/explorer?dimensions=vendor%2Cservice%2Caction%2Cregion&duration=ten-day&costBasis=on-demand')}</h3>
    ...
    <div class="card">
      <div class="section-title">🎯 Top Rightsizing Recommendations ${this.cldyLink('rightsizing/explorer?dimensions=vendor%2Cservice%2Caction%2Cregion&duration=ten-day&costBasis=on-demand')}
        <div class="pivot-controls" style="margin:0;margin-left:auto">
